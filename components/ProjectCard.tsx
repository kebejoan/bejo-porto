		...
		<div className="w-full flex flex-col gap-2">
			...
			<div className="flex flex-col lg:flex-row w-full gap-2">
				...
				<a
					...
					onClick={(e) => !live && e.preventDefault()} // Block navigation if empty
					className={`grow rounded-md text-center py-1 lg:py-2 font-bold transition-all ${
						!live
							? "bg-gray-400 cursor-not-allowed opacity-50"
							: "bg-bgblue hover:bg-bgblueflip hover:text-bgblue cursor-pointer"
					}`}
				>
					Live{"  "}
					<FontAwesomeIcon
				...
				<a
					...
					onClick={(e) => !repo && e.preventDefault()}
					className={`grow rounded-md text-center py-1 lg:py-2 font-bold transition-all ${
						!repo
							? "bg-gray-400 cursor-not-allowed opacity-50"
							: "bg-bgblue hover:bg-bgblueflip hover:text-bgblue cursor-pointer"
