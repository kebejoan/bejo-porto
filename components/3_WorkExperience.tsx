			...
			<div className="w-full col-span-4">
				<div className="w-full flex flex-col items-center gap-4 grid-span-2">
					<div className="w-full flex flex-col gap-2 px-4 ">
									...
									<MotionWrapper type="hover">
										<div className="pb-2 px-2 w-full bg-bgblue rounded-md my-2">
											...
											<p className="text-sm lg:text-base mt-2">
												...
												implementation at the Jakarta Wastewater Treatment
												Plant.
											</p>
										</div>
									</MotionWrapper>
									...
									<MotionWrapper type="hover">
										<div className="pb-2 px-2 w-full bg-bgblue rounded-md my-2">
											...
											<p className="text-sm lg:text-base mt-2">
												...
												engineering time from 5 days to 2-5 hours while being
												the mentor for the next generation of engineers.
											</p>
										</div>
									</MotionWrapper>
								</div>
									...
									<MotionWrapper type="hover">
										<div className="pb-2 px-2 w-full bg-bgblue rounded-md my-2">
											...
											<p className="text-sm lg:text-base mt-2">
												...
												from 3D enclosure and PCB design to firmware engineering
						...
						<MotionWrapper type="fade-in" delay={2.2}>
							<a
