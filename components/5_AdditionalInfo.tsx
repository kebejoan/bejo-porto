					...
					<div className="w-full flex flex-col gap-4">
						<div className="w-full flex flex-col rounded-md gap-2">
							...
							<div className="flex flex-col lg:flex-row gap-2 ">
								<MotionWrapper type="fade-in" delay={1} className="w-full">
								...
								<MotionWrapper type="fade-in" delay={1.2} className="w-full">
									<div className="w-full flex flex-col bg-bgblue rounded-md p-2 pb-5">
								...
								<MotionWrapper type="fade-in" delay={1.4} className="w-full">
									<div className="w-full flex flex-col bg-bgblue rounded-md p-2 pb-5">
								...
								<div className="flex flex-col lg:flex-row gap-2 ">
									<div className="w-full flex flex-col bg-bgblue rounded-md p-2 pb-5 text-wrap">
										...
										<a
											...
											target="_blank"
											className="flex gap-1 text-sm lg:text-base font-bold hover:text-blue-500 cursor-pointer underline"
										>
										...
										<a
											...
											target="_blank"
											className="text-sm lg:text-base font-bold hover:text-blue-500 cursor-pointer underline "
										>
