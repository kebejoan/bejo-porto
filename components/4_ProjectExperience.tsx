        ...
        <div className="w-fit flex gap-5 ">
          <button
            ...
            className={`w-fit font-pixel text-[1.4rem] lg:text-3xl transition-colors
              ${currentIndex === 0 ? "opacity-30 cursor-not-allowed" : "hover:cursor-pointer hover:text-bgblue"}`}
          >
            prev
          </button>
          <button
            ...
            className={`w-fit font-pixel text-[1.4rem] lg:text-3xl transition-colors
              ${currentIndex === projects.length - 1 ? "opacity-30 cursor-not-allowed" : "hover:cursor-pointer hover:text-bgblue"}`}
          >
            next
          </button>
        </div>
