							...
							<MotionWrapper type="hover">
								<div className="w-full flex flex-col bg-bgblue rounded-md gap-1 p-2">
									...
									<div className="text-sm lg:text-base mb-2">
										...
										<br />
										<strong>Final Projects</strong>: ENG-Tracker (Next.js,
										Tailwind, ShadCN, NestJS, PrismaORM and PostgreSQL)
									</div>
								</div>
							</MotionWrapper>
						</MotionWrapper>
							...
							<MotionWrapper type="hover">
								<div className="w-full flex flex-col bg-bgblue rounded-md p-2">
									...
									<div className="text-sm lg:text-base mb-2">
										...
										<strong>Publication</strong>: “Analysis of Indoor Air
										Quality Based on Low-Cost Sensor”
										<br />
