...
export default function GroundHero() {
	return (
		<div className="relative w-full h-screen ">
			...
			<div className="absolute top-50 w-full flex flex-col justify-center items-center gap-4">
				<div className="w-full lg:w-[1024]  flex flex-col justify-center items-center text-[8rem] text-wrap font-pixel">
					<div>Faishal Tahsiin</div>
				</div>
				<div className="w-full lg:w-[1024]  flex flex-col justify-center items-center text-3xl font-bold text-wrap ">
					<div>
			...
			<div className="absolute bottom-20 w-full flex flex-col justify-center items-center gap-4">
				<div className="w-full lg:w-[1024] flex flex-col justify-center items-center text-5xl font-pixel">
