      ...
      <div className="w-full col-span-4">
        <div className="w-full flex flex-col items-center gap-4  grid-span-2">
          <div className="w-full flex flex-col gap-4 p-4 ">
            ...
            {/* Revou */}
            <div className="w-full flex flex-col outline-3 rounded-md gap-1 p-2">
              <div className="w-full flex flex-col">
                <div className="font-bold">RevoU</div>
                <div className="text-sm lg:text-base mb-2  text-blue-500">
            ...
            {/* TelU */}
            <div className="w-full flex flex-col outline-3 rounded-md p-2">
              <div className="w-full flex flex-col">
